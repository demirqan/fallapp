...
import com.falapp.falciabla.ReadingResultActivity;
import com.falapp.falciabla.adapters.ReadingsAdapter;
...
public class ReadingsFragment extends Fragment implements ReadingsAdapter.ReadingClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fabNewReading.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(getActivity(), com.falapp.falciabla.MainActivity.class);
