package com.falapp.falciabla.fragments;
...
import com.falapp.falciabla.CoinPurchaseActivity;
import com.falapp.falciabla.R;
import com.falapp.falciabla.TarotDetailActivity;
...
public class TarotFragment extends Fragment {
    ...
    private void onCardClicked(int cardIndex) {
        ...
        boolean isPremium = requireActivity()
                .getSharedPreferences("app_prefs", Context.MODE_PRIVATE)
                .getBoolean("is_premium", false);

        if (selectedCardIndices.isEmpty() && !isPremium && currentUser.getCoins() < TAROT_COST) {
